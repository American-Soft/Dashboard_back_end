...
class SearchCustomerRequestRequest extends FormRequest
{
    /**
    ...
    {
        return [
            'id'         => ['nullable', 'integer', 'exists:customerrequests,id'],
            'phone'      => ['nullable','regex:/^01[0125][0-9]{8}$/','exists:customerrequests,phone_number'],
            'brand_name' => ['nullable', 'string', 'exists:brands,name'],
            'status'     => ['nullable', 'in:pending,approved,rejected,completed'], 
            'created_at' => ['nullable', 'date'],
            'domain'     => ['nullable', 'string', 'url','exists:customerrequests,domain'],
        ];
    }
